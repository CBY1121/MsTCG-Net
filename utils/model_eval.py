...
def eval(path):    #path = 'assets/octa/'
    ...
    Acc, Sen, Spe, F1, Dice, Kappa, G_mean, FDR = 0, 0, 0, 0, 0, 0, 0, 0
    file_num = 0
    ...
    print('Dice: {0:.4f}'.format(Dice / file_num))
    print('Kappa: {0:.4f}'.format(Kappa / file_num))
    print('G-mean: {0:.4f}'.format(G_mean / file_num))
    print('FDR: {0:.4f}'.format(FDR / file_num))
